# Desain User Interface Pada Multimedia Interaktif  <!-- omit in toc -->
...
- [Prinsip Desain User Interface](#prinsip-desain-user-interface)
  - [Prinsip User Compatibility](#prinsip-user-compatibility)
  - [Prinsip Product Compatibility](#prinsip-product-compatibility)
  - [Prinsip Task Compatibility](#prinsip-task-compatibility)
  - [Prinsip Work Flow Compatibility](#prinsip-work-flow-compatibility)
  - [Prinsip Consistency](#prinsip-consistency)
  - [Prinsip Familiarity](#prinsip-familiarity)
  - [Prinsip Simplicity](#prinsip-simplicity)
  - [Prinsip Direct Manipulation](#prinsip-direct-manipulation)
...
Di masa sekarang, perkembangan teknologi menghasilkan perkembangan yang cukup besar terhadap kehidupan. Dalam hal ini, teknologi informasi berpengaruh dalam proses akses yang tergolong sangat cepat. Dalam pendesainan interface terdapat beberapa prinsip utama antara lain sebagai berikut:

### Prinsip User Compatibility
Antarmuka bisa diterjemahkan sebagai cara masuk ke sebuah sistem atau sebuah pintu gerbang untuk memasuki sebuah sistem yang diwujudkan ke dalam sebuah aplikasi perangkat lunak (software). Dalam hal, seorang desainer harus mencari dan mengumpulkan berbagai karakteristik serta sifat dari user karena antarmuka harus menyesuaikan dengan user yang memiliki karakter yang berbeda.

Hal tersebut harus dipertimbangkan oleh desainer bukan merancang antarmuka didasarkan pada dirinya sendiri. Oleh karena itu, sebuah perangkat lunak seolah-olah mengenal user-nya, mengenal karakteristiknya, mulai dari sifat hingga kebiasaan-kebiasaannya secara umum. Salah satu caranya adalah dengan melakukan survei sebagai sesuatu hal yang tepat.

### Prinsip Product Compatibility
Sebuah aplikasi yang menggunakan antarmuka harus sesuai dengan sistem aslinya, sebab adakalanya sebuah aplikasi menghasilkan hasil yang berbeda dengan sistem manual ataupun dengan sistem yang sudah ada. Tujuan utama dari prinsip product compatibility adalah aplikasi perangkat lunak (software) yang dapat menjaga produk yang dihasilkan jauh lebih baik, misalnya sistem aplikasi report/laporan serta informasi yang detail dan akurat.

### Prinsip Task Compatibility
Sebuah aplikasi yang berdasarkan antarmuka harus mampu membantu para user dalam menyelesaikan tugasnya, di mana semua pekerjaan beserta tugas user dapat diadopsi dalam aplikasi melalui penggunaan antarmuka (interface). Dalam hal ini, user dihadapkan dengan pilihan yang mudah dan proses berpikir dari tugas-tugas user dipindahkan dalam aplikasi melalui antarmuka (interface) tersebut. Misalnya, dalam proses instalasi sesuatu software, user melakukan instalasi serta melanjutkan dengan cara menekan tombol Next → Next → Next → Finish → OK.

### Prinsip Work Flow Compatibility
Dalam sebuah aplikasi, seorang software engineer harus memikirkan berbagai rangkaian pekerjaan pada sebuah sistem dengan cara mengadopsi sistem manual yang di dalamnya terdapat urutan kerja dalam menyelesaikan pekerjaan. Tujuan utamanya adalah jangan sampai user mengalami kesulitan dalam menyelesaikan pekerjaannya karena mengalami kesulitan pada saat urutan pekerjaan pada sistem manual tidak ditemukan pada perangkat lunak (software) yang dihadapinya. Misalnya pada saat mencetak, user dihadapkan pada pilihan-pilihan menu yang banyak sebagai sebuah urutan dari rangkaian pekerjaan mencetak. Dengan prinsip workflow compatibility dapat membantu seorang user mempercepat pekerjaannya.

### Prinsip Consistency
Secara mendasar, prinsip consistency pada sebuah sistem harus sesuai dengan real system produk yang dihasilkan. Oleh karena itu, seorang software engineer harus memerhatikan hal-hal yang bersifat konsisten pada saat merancang aplikasi interface-nya, misalnya struktur menu dan font, penerapan warna, serta keseragaman format desain pada antarmuka di berbagai bagian, sehingga user tidak mengalami kesulitan pada saat berpindah lokasi dalam menyelesaikan pekerjaan yang bersangkutan. Misalnya perusahaan Microsoft membuat keseragaman tampilan toolbar pada Word, Excel, PowerPoint, dan Access hampir sama. Hal tersebut didasarkan pada karakteristik manusia yang memiliki pemikiran menggunakan analogi dan kemampuan manusia dalam melakukan proses prediksi.

### Prinsip Familiarity
Prinsip familiarity adalah memberikan tampilan yang familier kepada user agar tidak kesulitan dalam pemakaiannya. Misalnya, tampilan awal google.com yang sangat familier di mata user sehingga tidak mengalami kesulitan dalam menggunakannya.

### Prinsip Simplicity
Memberikan sistem sederhana dengan tujuan memudahkan si pemakai, karena pada dasarnya mereka lebih menyukai jika sistem tersebut memiliki nilai kesederhanaan. Hal pokok yang adakalanya membuat seorang user merasa bosan dapat diketahui dari sistem yang rumit atau berbelit-belit, sebab tidak selamanya antarmuka yang memiliki pilihan menu yang banyak merupakan antarmuka yang baik. Oleh sebab itu, kesederhanaan harus diperhatikan pada saat membangun sebuah antarmuka (interface). Hal yang perlu dipahami adalah kesederhanaan sebagai hal yang ringkas dan tidak terlalu berbelit namun berbobot.
